...
class Mlp(nn.Module):
    def __init__(self,config, dim=768, image_size=224, patch_size=16, expansion_factor=4, depth=4, class_num=9):
        super().__init__()
    ...
    def forward(self, x):
        ...
        # x = self.softmax(self.classifier(y))
        return x
...
class Block(nn.Module):
    def __init__(self, config, vis):
        ...
        self.ffn = Mlp(config)
#        self.ffn = Mlp(dim=768, image_size=224, patch_size=16, class_num=9)
